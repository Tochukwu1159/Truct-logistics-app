         ...
         <div id='content-wrapper' className='d-flex flex-column'>
           <div id='content'>
             ...
             <div className='container-fluid'>
               <h1 className='h3 mb-2 text-gray-800'>Transaction History</h1>
               <p className='mb-4'>
                     ...
                     >
                       <thead>
                         <tr>
                           <th>Customer id</th>
                           <th>Customer Name</th>
                           <th className='hideformobile vehicletype'>Address</th>
                           <th className='hideformobile drivername'>
                             Phone Contact
                           </th>
                           <th className='hidembilefortab'>Email</th>
                           <th className='hidembilefortab'>User Id Type</th>
